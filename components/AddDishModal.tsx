...
import { SparklesIcon, ChevronDownIcon, PlusIcon } from './Icons';
...
export const AddDishModal: React.FC<AddDishModalProps> = ({ isOpen, onClose, onAdd }) => {
  ...
  return (
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
        ...
        {/* Modal Content - Using standard translate/transition for animation effect simulator */}
        <div className="relative bg-white w-full sm:w-[450px] sm:rounded-3xl rounded-t-3xl p-6 shadow-2xl transform transition-transform duration-300 max-h-[90vh] overflow-y-auto no-scrollbar">
            ...
            <div className="grid grid-cols-2 gap-4 relative z-20">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  {/* Dropdown Menu */}
                  {isEmojiOpen && (
                      <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 p-3 z-30">
