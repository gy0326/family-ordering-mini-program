...
export default function App() {
  ...
  const handleAddDish = (name: string, category: DishCategory, description: string, emoji: string, imageUrl?: string) => {
    ...
    // Optional: Auto-select the newly added dish
    // setSelectedDishes(prev => new Set(prev).add(newDish.id));
  };
      ...
      <div className="min-h-screen bg-[#FDFBF7] text-dark font-sans flex flex-col max-w-md mx-auto relative shadow-2xl border-x border-gray-100">
        ...
        {showOrderSheet && selectedDishes.size > 0 && (
            <>
              ...
              <div className="fixed bottom-24 left-4 right-4 bg-white rounded-3xl shadow-xl z-30 p-4 max-w-[calc(100%-2rem)] mx-auto max-h-[60vh] flex flex-col md:max-w-md">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 flex justify-end gap-3 shrink-0">
                  <button
